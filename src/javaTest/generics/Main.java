...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("SCORE MAX IS " + " " +hs.getNameCheckDiem("MAX") + " WITH SCORE " + hs.checkDiem("MAX"));
		System.out.println("SCORE MIN IS"  + " " +hs.getNameCheckDiem("MIN") + " WITH SCORE " + hs.checkDiem("MIN"));
		System.out.println(Caculator.getDiemTB());
	}
